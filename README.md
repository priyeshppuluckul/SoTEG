...
<p align="center" width="100%">
  <img width="30%" src="img/soteg_sketch.png" alt="A sketch of the SoTEG showing different components and their assembly" width="50%">
...
<p align="center" width="100%">
  <img width="50%"src="img/soteg_model.png" alt="A diagrammatic representation of the model showing different heat transfer models">
...
<p align="justify">where $\varepsilon _{sky}$ is the  emissivity of the sky which depends on dew temperature $T_{d}$ and sky opacity N. Models in [SkyTemperature.py](./SkyTemperature.py) can be used if dew point and opaque sky cover are known. For approximate calculations, the temperature of the sky can be assumed to be 0°C.</p> <br>
